...
# only contain word characters (alphanumeric characters and underscores).
...
# Use re.search with the pattern "^\w+@\w+\.edu$" to check if "@" and ".edu" are present at the beginning and end,
...
# It then uses re.search with the pattern "^\w+@\w+\.edu$" to check if "@" and ".edu" are present at the beginning and end,
# and if the username and domain only contain word characters (alphanumeric characters and underscores).
