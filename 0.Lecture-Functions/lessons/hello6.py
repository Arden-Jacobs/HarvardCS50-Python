...
# In this section, we're introducing string manipulation techniques. The user's name is obtained 
# using the input() function, and then the strip() method is applied to remove any leading or 
# trailing whitespace. Additionally, the title() method is used to capitalize the first letter of
# each word in the input. The print() function then uses an f-string to create a personalized greeting
# with the manipulated name.