# say4.py - Demonstrates using a custom module for generating a message

# Import the sys module for command-line arguments
import sys

# Import the "hello" function from the custom module "sayings2"
...
# The import statement "from sayings2 import hello" imports the "hello" function from the custom module "sayings2".
...
# the "hello" function from the "sayings2" module is called to generate a message using the provided argument.
