# students4.py - Reads and processes a CSV file containing student information into a list of dictionary objects
...
with open("students0.csv") as file:
    for line in file:
        ...
        # Create a dictionary with student name and house information
...
# A new dictionary named "student" is created using dictionary literal syntax. The dictionary is populated with two key-value pairs
