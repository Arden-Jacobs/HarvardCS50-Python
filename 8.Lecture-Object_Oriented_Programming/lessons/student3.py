# File Name: student3.py

# Description: This script defines a 'get_student' function to collect a student's name and house and return them as a tuple.
# The 'main' function calls 'get_student' to collect the information and uses indexing to access the tuple elements for display.

# Define the main function.
def main():
    # Call the 'get_student' function to collect the student's name and house as a tuple.
    student = get_student()
...
#   which is stored in the 'student' variable. It then uses indexed access to tuple elements to display the student's information
...
# This script efficiently captures and displays information about a student using tuples and indexed access to tuple elements.
