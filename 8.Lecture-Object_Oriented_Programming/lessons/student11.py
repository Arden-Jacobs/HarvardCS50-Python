...
# It eliminates the unnecessary variable 'student' in the 'get_student' function, simplifying the code.
...
# By eliminating the unnecessary 'student' variable in the 'get_student' function, this script simplifies the code while achieving the same result.
