...
#   an instance of the 'Student' class directly. It then accesses the 'name' and 'house' attributes of the 'student' instance and displays them
...
# allowing the user to input the student's name and house and demonstrates how to create and use a class instance with added validation.

# The added validation in the constructor ensures that the 'name' is not empty and the 'house' is one of the valid options, improving the robustness
# of the script.
